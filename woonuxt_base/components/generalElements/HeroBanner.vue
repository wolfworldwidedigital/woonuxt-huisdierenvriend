<template>
  <div class="relative mx-auto">
    ...
    <div class="container absolute inset-0 flex flex-col items-start justify-center bg-gradient-to-l from-gray-200 md:bg-none p-8">
      <h1 class="text-3xl font-bold md:mb-4 md:text-4xl lg:text-6xl">De mooiste avonturen</h1>
      <h2 class="text-lg font-bold md:mb-4 lg:text-3xl">beginnen met een pootafdruk naast die van jou.</h2>
      <div class="max-w-sm mb-8 text-md font-light lg:max-w-md text-balance">
        <p>Elk huisdier heeft een verhaal; wij helpen je om het te vertellen.</p>
      </div>
